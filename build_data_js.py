...
with open('chapter_data_backup/chapter_summaries/all_chapters.json', 'r', encoding='utf-8') as f:
...
# Add minimal charactersByChapter (just 1-10 with real data, rest minimal)
...
# Add summaries
for i in range(1, 68):
    escaped_summary = summaries[str(i)].replace('\\', '\\\\').replace('"', '\\"')
